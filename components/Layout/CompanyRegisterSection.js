        ...
        <div className="container">
          <div className="row">
            <div className="col-xs-12 col-sm-12">
              <h3 style={{ marginBottom: 50, marginTop: 50, textAlign: 'center' }}>Why you’ll love becoming a host</h3>
            </div>
        ...
        <div className="section-standard mt-gradient-4">
          <div className="text-center">
            ...
            <div className="standard-desc">
              ...
              We’ve created standards and expectations to help keep our community safe, 
              and to help everyone on Airbnb travel and host with more confidence. 
            </div>
          </div>
        </div>
        <style jsx>
